...
const activities = [
  {
    name: 'Walking',
    icon: Footprints,
    activeColor: 'bg-activity-walking/30',
    inactiveColor: 'bg-activity-walking/10',
    pattern: [true, true, false, true, true, false, false],
  },
  {
    name: 'Sleep',
    icon: Moon,
    activeColor: 'bg-activity-sleep/30',
    inactiveColor: 'bg-activity-sleep/10',
    pattern: [true, true, true, true, true, false, false],
  },
  {
    name: 'Hydration',
    icon: Droplets,
    activeColor: 'bg-activity-hydration/30',
    inactiveColor: 'bg-activity-hydration/10',
    pattern: [false, true, true, false, true, false, false],
  },
  {
    name: 'Stretching',
    icon: PersonStanding,
    activeColor: 'bg-activity-stretching/30',
    inactiveColor: 'bg-activity-stretching/10',
    pattern: [true, false, true, false, true, false, false],
  },
  {
    name: 'Mindfulness',
    icon: Brain,
    activeColor: 'bg-activity-mindfulness/30',
    inactiveColor: 'bg-activity-mindfulness/10',
    pattern: [true, true, false, true, true, false, false],
  },
];
